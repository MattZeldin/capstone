<template>
    <div>
        ...
        <h2>Progress: </h2>
        <h3>Days so far this week: <!--{{ this.$store.state.workouts.days running total}}--></h3>
        <h3>Average minutes per workout: <!--{{ this.$store.state.workouts.minutes but average }}--> </h3>
    </div>
</template>
